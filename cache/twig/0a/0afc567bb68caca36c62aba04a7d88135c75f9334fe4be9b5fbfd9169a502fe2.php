...
class __TwigTemplate_fe80f49d78ce3c7b12b60ae699268436e862e50b79afa21f06548335bdd4cca5 extends \Twig\Template
{
...
<table class=\"cron-status noflex\">
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["job"]) {
            ...
            // line 16
            echo "        ";
            $context["job_enabled"] = ((((isset($context["job_status"]) || array_key_exists("job_status", $context)) && (($context["job_status"] ?? null) == "disabled"))) ? (0) : (1));
            // line 17
            echo "        ";
            $context["job_id"] = $this->getAttribute($context["job"], "id", []);
            // line 18
            echo "        ";
            $context["job_id_md5"] = $this->env->getExtension('Grav\Common\Twig\TwigExtension')->md5Filter(($context["job_id"] ?? null));
            // line 19
            echo "        ";
            ...
            if (($context["job_backlink"] ?? null)) {
                // line 25
                echo "                    <a href=\"";
                echo twig_escape_filter($this->env, (($context["base_url_relative"] ?? null) . ($context["job_backlink"] ?? null)), "html", null, true);
                echo "\"><kbd>";
            ...
            if (($context["job_enabled"] ?? null)) {
                ...
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($this->env->getExtension('Grav\Common\Twig\TwigExtension')->cronFunc(($context["job_at"] ?? null)), "getNextRunDate", [], "method"), $this->getAttribute($this->getAttribute(($context["config"] ?? null), "date_format", []), "default", [])), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\TwigExtension')->niceCronFilter(($context["job_at"] ?? null)), "html", null, true);
                echo "</span>
                ";
            } else {
                // line 34
...
", "forms/fields/cronstatus/cronstatus.html.twig", "/var/www/html/grav-admin/user/plugins/admin/themes/grav/templates/forms/fields/cronstatus/cronstatus.html.twig");
    }
}
